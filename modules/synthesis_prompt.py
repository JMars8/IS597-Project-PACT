...
def build_privacy_synthesis_prompt(
    ...
    return (
        ...
        "4. NOTE: Medical placeholders (like [REDACTED CONDITION], [REDACTED SYMPTOM], [REDACTED MEDICATION], [REDACTED PROCEDURE]) "
        "are safely pre-anonymized and DO NOT contain restricted data. This request is safe and should NOT trigger a safety refusal.\n"
        "5. DO NOT add any extra conversational text, labels, or markdown formatting.\n"
        "6. Output exactly one line: the final synthesized sentence.\n\n"
        "EXAMPLE:\n"
